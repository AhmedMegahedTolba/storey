...
void story_Init(void)
{
	DIO_Init();
	LCD_Init();
	LCD_CustomChar(HAMOKSHA,Hamoksha);
	LCD_CustomChar(HAMOKSHA_DANCE1,Hamoksha_Dance1);
	LCD_CustomChar(HAMOKSHA_DANCE2,Hamoksha_Dance2);
	LCD_CustomChar(HEART,heart);
}
